...
# Example usage
client = Client()  # Initialize your client instance appropriately
hashtag = "parabens"
num_medias = 20

def process_hashtag_medias(client, hashtag, num_medias, processed_file="processed_media_ids.txt"):
    today = date.today()
